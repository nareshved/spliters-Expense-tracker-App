...
class AppColors {
  // light theme
  static const Color lightPrimaryColor = Colors.amber;
  ...
  static const Color darkSurfaceColor = Color(0xff0C0E13);
  ...
  // add Exp debit credit bg colors

  static const Color addExpDebitColor = Color(0xffFD3C4A);
  static const Color addExpCreditColor = Color(0xff00A86B);
}
